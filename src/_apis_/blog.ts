...
// types
import { BlogUser, Post, PostComment } from "../@types/blog";
...
export const users: BlogUser[] = [...Array(12)].map((user, index) => {
...
const POST_COMMENTS: PostComment[] = [
  {
...
export const posts: Post[] = [...Array(23)].map((blog, index) => {
  const setIndex = index + 1;
  return {
